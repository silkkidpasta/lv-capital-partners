  ...
  useEffect(() => {
    ...
    const initialNotifications: Notification[] = [
      ...
      },
      {
        ...
        message: 'K-1 tax documents for 2024 are now ready for download',
        priority: 'medium',
      ...
      },
      {
        ...
        message: 'Phoenix Retail Center - Early access available for qualified investors',
        priority: 'medium',
    ...
    const intervalId = setInterval(() => {
      const randomNotifications: Partial<Notification>[] = [
        ...
        },
        {
          type: 'alert',
          title: 'Market Update',
          message: 'Commercial real estate market shows strong fundamentals',
          priority: 'low'
        }
      ]
                    ...
                    <div className="space-y-1">
                      {notifications.map((notification, index) => (
                        <motion.div
                          ...
                          className={`p-4 hover:bg-vault-background/20 transition-colors border-l-4 ${
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <h4 className={`text-sm font-medium ${
                                    notification.read ? 'text-vault-muted' : 'text-vault-primary'
                                  }`}>
                                    {notification.title}
                                  </h4>
                                  ...
                                  {notification.amount && (
                                    <p className="text-sm font-semibold text-vault-accent mt-1">
...
EOF  
cd /home/project && cd lv-capital-partners/src/components/dashboard && cat > realtime-notifications.tsx << 'EOF'
'use client'
